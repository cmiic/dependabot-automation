...
- allows `github_actions`, `npm_and_yarn`, `devcontainers`, `docker`, and `pip`
...
- checks changed pip requirement files for newly introduced dependencies on `pip`
- treats new or unreadable pip requirement files as manual review
...
- `allowed-ecosystems`: default `github_actions,npm_and_yarn,devcontainers,docker,pip`
